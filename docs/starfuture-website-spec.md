...
[Hero Section] 宇宙星空主題
    ...
    - 說明文字：我們打造實用的 AI 工具，為經紀公司與個人工作者解決日常管理難題
    - CTA：探索產品（主要）/ 聯繫我們（次要）
  ...
  "products": [
    {
      ...
      "name": "ContraX",
      "tagline": "經紀公司的合約管家",
      "description": "專為影視、出版、內容經紀公司設計的合約管理系統，從建立、追蹤、收款到歸檔，一站式管理合約生命週期。",
      "icon": "file-contract",
      "tags": ["合約管理", "經紀公司", "桌面軟體"],
      "targetAudience": "影視/出版/內容經紀公司",
      "type": "單機桌面軟體",
...
[Hero]
    標題：ContraX 合約管理系統
    Tagline：經紀公司的合約管家
    說明：專為影視、出版、內容經紀公司設計，一站式管理合約生命週期
